...
Этот код организует поток данных о поездках на такси, фильтрует его по географическим координатам, и выводит отфильтрованные данные или проводит тестирование этой операции очистки данных.
Решение:
```scala
...
```
Тест:
![image](https://github.com/sumrako/BigDataLR/assets/67976572/eb2d45cb-51c7-4660-86a4-c317452032cc)


## 2. RidesAndFaresExercise
Идея состоит в объединении потоков данных о поездках и тарифах на основе временного соответствия, используя состояния для временного хранения их данных до момента сопоставления.
```scala
/*
...
```
Тест:
![image](https://github.com/sumrako/BigDataLR/assets/67976572/5b966f30-0f7e-4a36-aeba-a2ed6cd22663)

## 3. HourlyTipsExerxise
Проводим анализ данных о чаевых такси, выявив наивысшие суммы чаевых за каждый час и для каждого водителя, используя оконные функции времени для агрегации и анализа данных.
```scala
/*
...
```
Тест:
![image](https://github.com/sumrako/BigDataLR/assets/67976572/d4ac1eb0-d4d5-44da-8b58-bf288c9a1f00)
...
```
Тест:
![image](https://github.com/sumrako/BigDataLR/assets/67976572/9d4be9ad-0641-4940-bd78-461e6306e763)
